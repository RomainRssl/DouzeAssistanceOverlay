...
namespace LMUOverlay.Models
{
    ...
    public class OverlaySettings : INotifyPropertyChanged
    {
        ...
        public double OverlayWidth
        {
            ...
            set
            {
                ...
                if (Math.Abs(_overlayWidth - v) < 0.001) return;
                _overlayWidth = v;
                OnPropertyChanged();
            }
        }
        ...
        public double OverlayHeight
        {
            ...
            {
                double v = Math.Max(0, value);
                if (Math.Abs(_overlayHeight - v) < 0.001) return;
                _overlayHeight = v;
                OnPropertyChanged();
            }
        }
    ...
    public class InputDisplayConfig
    {
        ...
        /// <summary>Show/hide the vertical T/B/C bars on the left side of the graph.</summary>
        ...
        /// <summary>Number of seconds of input history shown in the graph (1–15 s).</summary>
        public int HistorySeconds { get; set; } = 4;
