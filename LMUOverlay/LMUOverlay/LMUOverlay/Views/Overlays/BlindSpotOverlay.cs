...
namespace LMUOverlay.Views.Overlays
{
    ...
    public class BlindSpotOverlay : BaseOverlayWindow
    {
        ...
        private static Color CBracket    => ThemeManager.Current.TextSecondary;
        private static Color CLabel      => ThemeManager.Current.TextPrimary;
        private static Color CSqOff      => Color.FromArgb(80, ThemeManager.Current.StateWarn.R, 40, 0);
        ...
        private static (Canvas, Border, DropShadowEffect) MakePanel(string side)
        {
            ...
            cv.Children.Add(new Border
            {
                Width        = NatW,
                Height       = NatH,
                Background   = BrushCache.Get(CBackground),
            ...
            var sq = new Border
            {
                ...
                Background   = BrushCache.Get(CSqOff),
                Effect       = glow
            };
        ...
        private static void Ln(Canvas c, double x1, double y1, double x2, double y2, double t)
            => c.Children.Add(new Line
            {
                ...
                Stroke = BrushCache.Get(CBracket), StrokeThickness = t,
        ...
        private static void Lbl(Canvas c, string text, double y)
        {
            var tb = new TextBlock
            {
                ...
                Foreground = BrushCache.Get(CLabel),
        ...
        private static void Apply(Border sq, DropShadowEffect fx, double intensity)
        {
            if (intensity <= 0)
            {
                sq.Background = BrushCache.Get(CSqOff);
                fx.Opacity    = 0;
                fx.BlurRadius = 0;
                return;
            }
            ...
            sq.Background = BrushCache.Get(col);
            fx.Color      = col;
