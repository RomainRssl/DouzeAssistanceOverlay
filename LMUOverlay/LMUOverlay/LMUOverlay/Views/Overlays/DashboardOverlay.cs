    ...
    public class DashboardOverlay : BaseOverlayWindow
    {
        ...
        public DashboardOverlay(DataService ds, OverlaySettings s, DashboardDisplayConfig cfg) : base(ds, s)
        {
            ...
            _speedBarBg = new Border
            {
                ...
                Background = BrushCache.Get(Color.FromArgb(60, tm0.ClassLmp2.R, tm0.ClassLmp2.G, tm0.ClassLmp2.B)),
            ...
            _speedBarFill = new Border
            {
                ...
                Background = BrushCache.Get(OverlayHelper.AccBlue),
        ...
        public override void UpdateData()
        {
            ...
            Color speedCol = d.Speed > 300 ? tm.StateDanger :
                             d.Speed > 200 ? tm.ClassLmp2 :
                             Color.FromRgb((byte)(tm.ClassLmp2.R / 2), (byte)(tm.ClassLmp2.G * 3 / 4), (byte)(tm.ClassLmp2.B * 3 / 4));
            ...
            if (rpmPct > 0.97)
            {
                ...
                Color wantBar  = on ? tm.StateDanger : Color.FromRgb((byte)(tm.StateDanger.R / 3), 0, 0);
                Color wantBg   = on ? Color.FromRgb((byte)(tm.StateDanger.R / 4), 10, 10) : Color.FromRgb(20, (byte)(tm.ClassLmp2.G / 6), (byte)(tm.ClassLmp2.B / 6));
                Color wantText = on ? tm.TextPrimary : Color.FromRgb((byte)(tm.StateDanger.R * 3 / 4), 80, 80);
            ...
            else
            {
                ...
                Color bgCol   = Color.FromRgb(20, (byte)(tm.ClassLmp2.G / 6), (byte)(tm.ClassLmp2.B / 6));
            ...
            if (_lapCellBorder != null && _lapLabel != null && _lapValue != null)
            {
                ...
                if (lapVisible)
                {
                    if (d.PitLimiter)
                    {
                        ...
                        _lapCellBorder.Background = BrushCache.Get(pitOn ? Color.FromRgb(0, (byte)(tm.StateGood.G / 3), (byte)(tm.StateGood.B / 4)) : Color.FromRgb(0, (byte)(tm.StateGood.G / 8), (byte)(tm.StateGood.B / 8)));
                        _lapLabel.Text = "PIT";
                        _lapLabel.Foreground = BrushCache.Get(pitOn ? tm.StateGood : Color.FromRgb(0, (byte)(tm.StateGood.G / 2), (byte)(tm.StateGood.B / 2)));
                        _lapValue.Text = "LIMITER";
                        _lapValue.FontSize = 9;
                        _lapValue.Foreground = BrushCache.Get(pitOn ? Color.FromRgb((byte)(tm.StateGood.R * 2), (byte)(tm.StateGood.G * 9 / 10), (byte)(tm.StateGood.B * 6 / 5)) : Color.FromRgb(0, (byte)(tm.StateGood.G / 3), (byte)(tm.StateGood.B / 3)));
                    }
                    else
                    {
                        _pitFlashCounter = 0;
