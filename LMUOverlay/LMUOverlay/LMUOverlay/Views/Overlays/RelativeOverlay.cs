...
namespace LMUOverlay.Views.Overlays
{
    ...
    public class RelativeOverlay : BaseOverlayWindow
    {
        ...
        public RelativeOverlay(DataService ds, OverlaySettings s, RelativeConfig cfg) : base(ds, s)
        {
            ...
            // Header row
            var hdr = MakeGrid();
            AddTb(hdr, "P",      0, FS_S, ThemeManager.Current.TextMuted, HorizontalAlignment.Center);
            AddTb(hdr, "DRIVER", 2, FS_S, ThemeManager.Current.TextMuted, HorizontalAlignment.Left);
            AddTb(hdr, "GAP",    4, FS_S, ThemeManager.Current.TextMuted, HorizontalAlignment.Right);
            sp.Children.Add(hdr);
            sp.Children.Add(new Border { Height = 1, Background = BrushCache.Get(ThemeManager.Current.Border), Margin = new Thickness(0, 2, 0, 2) });
        ...
        private static RelRow BuildEmptyRow()
        {
            ...
            var container = new Border
            {
                ...
                BorderBrush     = BrushCache.Get(ThemeManager.Current.AccentSecondary),
        ...
        public override void UpdateData()
        {
            ...
            for (int i = 0; i < _rows.Length; i++)
            {
                ...
                row.Container.Background      = isPlayer ? BrushCache.Get(Color.FromArgb(50, tmr.AccentSecondary.R, tmr.AccentSecondary.G, tmr.AccentSecondary.B)) : BrushCache.Get(Colors.Transparent);
                ...
                row.Name.Foreground = isPlayer ? BrushCache.Get(tmr.AccentSecondary) : BrushCache.Get(tmr.TextPrimary);
