    ...
    public class FlagOverlay : BaseOverlayWindow
    {
        ...
        public FlagOverlay(DataService ds, OverlaySettings s) : base(ds, s)
        {
            ...
            _hazardBorder = new Border
            {
                ...
                Background = BrushCache.Get(Color.FromArgb(200, (byte)(ThemeManager.Current.StateWarn.R / 5), (byte)(ThemeManager.Current.StateWarn.G / 5), 0)),
            ...
            {
                FontSize = 7, FontFamily = OverlayHelper.FontConsolas,
        ...
        public override void UpdateData()
        {
            ...
            switch (state)
            {
                ...
                case "YELLOW":
                    ...
                    Flag("JAUNE", yDetail,
                        ThemeManager.Current.StateWarn, Color.FromRgb(30, 30, 30));
                    break;
                ...
                case "BLUE":
                    ...
                    Flag("BLEU", "Laissez passer",
                        ThemeManager.Current.ClassLmp2, Colors.White);
                    ShowBlueFlagSide();
                    break;
                ...
                case "RED":
                    ...
                    Flag("ROUGE", "Session arrêtée",
                        ThemeManager.Current.StateDanger, Colors.White);
                    break;

                case "CHECKERED":
                    _flagBorder.Visibility = Visibility.Visible;
                    Flag("DAMIER", "Fin de course",
                        ThemeManager.Current.TextPrimary, Color.FromRgb(30, 30, 30));
                    break;
                ...
                if (hazards.Count > 0)
                {
                    ...
                    switch (h.Side)
                    {
                        case HazardSide.Left:
                            ...
                            _hazardArrow.Foreground = BrushCache.Get(ThemeManager.Current.StateWarn);
                            break;
                        ...
                        case HazardSide.Center:
                            ...
                            _hazardArrow.Foreground = BrushCache.Get(
                                cOn ? ThemeManager.Current.StateDanger : ThemeManager.Current.StateWarn);
                            break;
                        default:
                    ...
                    if (h.Distance < 100)
                    {
                        ...
                        var tw = ThemeManager.Current.StateWarn;
                        _hazardBorder.Background = BrushCache.Get(
                            flash ? Color.FromArgb(220, tw.R, (byte)(tw.G / 3), 0) : Color.FromArgb(180, (byte)(tw.R / 5), (byte)(tw.G / 5), 0));
                    }
                    else
                    {
                        var tw = ThemeManager.Current.StateWarn;
                        _hazardBorder.Background = BrushCache.Get(Color.FromArgb(200, (byte)(tw.R / 5), (byte)(tw.G / 5), 0));
                    }
                }
                else
                {
        ...
        private void ShowBlueFlagSide()
        {
            ...
            _hazardBorder.Visibility = Visibility.Visible;
            _hazardBorder.Background = BrushCache.Get(Color.FromArgb(200, 0, 30, (byte)(ThemeManager.Current.ClassLmp2.B / 3)));

            if (best.relX < -0.5)
            {
                _hazardArrow.Text = "◄◄◄ GAUCHE";
                _hazardArrow.Foreground = BrushCache.Get(ThemeManager.Current.ClassLmp2);
            }
